/**
 * IANA 时区 -> [纬度, 经度]（十进制度）。
 * 由 /usr/share/zoneinfo/zone.tab 的 ISO6709 坐标解析生成（418 项）。
 * 供世界时间工具页与首页只读时钟组件共用，作 equirectangular 地图打点。
 * 打点公式（与自绘 world-outline.svg 同投影）：
 *   left% = (lon + 180) / 360 * 100
 *   top%  = (90 - lat) / 180 * 100
 */
export const ZONE_LATLON: Record<string, [number, number]> = {
