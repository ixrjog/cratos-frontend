...
@Component({
  selector: 'app-kubernetes-resource-member-editor',
  templateUrl: './kubernetes-resource-member-editor.component.html',
  styleUrls: [ './kubernetes-resource-member-editor.component.less' ],
})
export class KubernetesResourceMemberEditorComponent implements OnInit {
