...
@Component({
  ...
  templateUrl: './kubernetes-resources-data-table.component.html',
  styleUrls: [ './kubernetes-resources-data-table.component.less' ],
})
export class KubernetesResourcesDataTableComponent implements OnInit{
