...
@Component({
  ...
  templateUrl: './kubernetes-resources-member-data-table.component.html',
  styleUrls: [ './kubernetes-resources-member-data-table.component.less' ],
})
export class KubernetesResourcesMemberDataTableComponent {
  ...
  dialogDate = {
    editorData: {
      ...
      content: KubernetesResourcesMemberEditorComponent,
      maxHeight: '1000px',
    },
    warningOperateData: {
