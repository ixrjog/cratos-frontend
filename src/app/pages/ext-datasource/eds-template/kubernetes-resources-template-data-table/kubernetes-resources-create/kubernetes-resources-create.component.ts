...
@Component({
  selector: 'app-kubernetes-resources-create',
  templateUrl: './kubernetes-resources-create.component.html',
  styleUrls: [ './kubernetes-resources-create.component.less' ],
})
export class KubernetesResourcesCreateComponent implements OnInit {
