...
} from './kubernetes-resources-template-editor/kubernetes-resource-template-editor.component';
import { KubernetesResourceService } from '../../../../@core/services/kubernetes-resource.service';
import { KubernetesResourcesCreateComponent } from './kubernetes-resources-create/kubernetes-resources-create.component';
import {
...
@Component({
  ...
  templateUrl: './kubernetes-resources-template-data-table.component.html',
  styleUrls: [ './kubernetes-resources-template-data-table.component.less' ],
})
export class KubernetesResourcesTemplateDataTableComponent implements OnInit {
  ...
  dialogDate = {
    ...
    createResourceData: {
      ...DIALOG_DATA.editorData,
      content: KubernetesResourcesCreateComponent,
    },
    cloneResourceTemplateData: {
      ...DIALOG_DATA.editorData,
      content: KubernetesResourcesTemplateCloneComponent,
    },
    warningOperateData: {
