...
@Component({
  selector: 'app-work-order-application-redeploy-ticket',
  templateUrl: './work-order-application-redeploy-ticket.component.html',
  styleUrls: ['./work-order-application-redeploy-ticket.component.less']
})
export class WorkOrderApplicationRedeployTicketComponent implements OnInit {
  ...
  onRowAdd() {
    this.workOrderTicketEntryService.addApplicationRedeployTicketEntry({
